const CP1251_EXTRA_CHARS: Record<string, number> = {
...
export function encodeCp1251(value: string): string {
...
export function decodeCp1251(buffer: ArrayBuffer): string {
  return new TextDecoder('windows-1251').decode(buffer);
}

export async function decodeCp1251Response(response: Response): Promise<string> {
